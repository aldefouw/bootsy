    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              "<a class='bootsy-button btn btn-default dropdown-toggle btn-sm" + size + "' data-toggle='dropdown' href='#' title='" + locale.font_styles.title + "'>" +
        ...
        "emphasis": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='bootsy-button btn btn-default btn-sm " + size + "' data-wysihtml5-command='bold' title='CTRL+B' tabindex='-1'>" + locale.emphasis.bold + "</a>" +
                "<a class='bootsy-button btn btn-default btn-sm " + size + "' data-wysihtml5-command='italic' title='CTRL+I' tabindex='-1'>" + locale.emphasis.italic + "</a>" +
                "<a class='bootsy-button btn btn-default btn-sm " + size + "' data-wysihtml5-command='underline' title='CTRL+U' tabindex='-1'>" + locale.emphasis.underline + "</a>" +
              "</div>" +
            "</li>";
        },
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='bootsy-button btn btn-default btn-sm " + size + "' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "' tabindex='-1'><i class='fa fa-list '></i></a>" +
                "<a class='bootsy-button btn btn-default btn-sm " + size + "' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "' tabindex='-1'><i class='fa fa-th-list'></i></a>" +
                "<a class='bootsy-button btn btn-default btn-sm " + size + "' data-wysihtml5-command='Outdent' title='" + locale.lists.outdent + "' tabindex='-1'><i class='fa fa-indent'></i></a>" +
                "<a class='bootsy-button btn btn-default btn-sm " + size + "' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "' tabindex='-1'><i class='fa fa-indent fa-flip-horizontal'></i></a>" +
              "</div>" +
            "</li>";
        },
                ...
                "<div class='modal-dialog'>" +
                  "<div class='modal-content'>" +
                    ...
                    "<div class='modal-footer'>" +
                      "<a href='#' class='bootsy-button btn btn-default btn-sm' data-dismiss='modal'>" + locale.link.cancel + "</a>" +
                      "<a href='#' class='bootsy-button btn btn-primary btn-sm' data-dismiss='modal'>" + locale.link.insert + "</a>" +
                    "</div>" +
                  "</div>" +
                "</div>" +
              "</div>" +
              "<a class='bootsy-button btn btn-default btn-sm" + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class='fa fa-share'></i></a>" +
            "</li>";
        },
              ...
              "<div class='bootstrap-wysihtml5-insert-image-modal modal fade' tabindex='-1' role='dialog' aria-hidden='true'>" +
                "<div class='modal-dialog'>" +
                  "<div class='modal-content'>" +
                    ...
                    "</div>" +
                    "<div class='modal-footer'>" +
                      "<a href='#' class='bootsy-button btn btn-default btn-sm ' data-dismiss='modal'>" + locale.image.cancel + "</a>" +
                      "<a href='#' class='bootsy-button btn btn-primary btn-sm' data-dismiss='modal'>" + locale.image.insert + "</a>" +
                    "</div>" +
                  "</div>" +
                "</div>" +
              "</div>" +
              "<a class='bootsy-button btn btn-default " + size + "' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' tabindex='-1'><i class='fa fa-picture-o'></i></a>" +
            "</li>";
        },
        ...
        "html": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='bootsy-button btn btn-default btn-sm " + size + "' data-wysihtml5-action='change_view' title='" + locale.html.edit + "' tabindex='-1'><i class='fa fa-pencil'></i></a>" +
              "</div>" +
            "</li>";
        },
        ...
        "color": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li class='dropdown'>" +
              "<a class='bootsy-button btn btn-default dropdown-toggle btn-sm" + size + "' data-toggle='dropdown' href='#' tabindex='-1' title='" + locale.colours.title + "'>" +
